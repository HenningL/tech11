...
Once the runtime starts, you can access the project at [http://localhost:8080/jakartaee-hluther](http://localhost:8080/jakartaee-hluther).
...
```
./mvnw clean package
docker build -t jakartaee-hluther:v1 .
```

You can then run the Docker image by executing:

```
docker run -it --rm -p 8080:8080 jakartaee-hluther:v1
```
